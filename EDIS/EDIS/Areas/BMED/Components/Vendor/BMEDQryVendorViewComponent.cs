...
namespace EDIS.Areas.BMED.Components.Vendor
{
    public class BMEDQryVendorViewComponent : ViewComponent
    {
        private readonly BMEDDbContext _context;

        public BMEDQryVendorViewComponent(BMEDDbContext context)
        {
            _context = context;
        }
